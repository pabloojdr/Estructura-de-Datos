...
máximoDeTres :: Integer -> Integer -> Integer -> Integer -- Los tipos deben coincidir
...
códigosDe x = (ord(toUpper x), ord(toLower x))
...
iguales :: Eq a => (a, a) -> (a, a) -> Bool --Eq sirve para poder usar Equals
